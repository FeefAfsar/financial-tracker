      ...
      <div className="space-y-2.5 w-full max-h-64 overflow-y-auto pr-2 custom-scrollbar">
        {filteredTransactions.map((t) => (
          <div 
            ...
            className="flex justify-between items-center p-4 bg-zinc-50/50 dark:bg-zinc-950/40 hover:bg-zinc-100 dark:hover:bg-zinc-900 rounded-xl border border-zinc-100/80 dark:border-zinc-900 w-full gap-3 cursor-pointer group hover:scale-[1.01] hover:border-emerald-500/20 dark:hover:border-emerald-500/20 hover:shadow-sm fluid-bounce"
          >
